...
public abstract class AbstractHttpClient {
    ...
    private void setSSL(HttpURLConnection uc) throws NoSuchProviderException, NoSuchAlgorithmException,
            KeyManagementException, UnrecoverableKeyException, KeyStoreException {
        if (!(uc instanceof HttpsURLConnection)) {
            return;
        }
        HttpsURLConnection httpsURLConnection = (HttpsURLConnection) uc;
...
//        SSLSocketFactory ssf = new SSLSocketFactory(new KeyStore());
