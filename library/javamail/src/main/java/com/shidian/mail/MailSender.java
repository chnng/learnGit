...
public class MailSender {
     ...
     */
    public boolean sendTextMail(final MailInfo mailInfo) throws MessagingException {
        // 判断是否需要身份认证
...
//		});
     ...
     * @param info
     */
    public static void sendFileMail(MailInfo info, File[] files) throws Exception {
     ...
     * @return
     */
    private static Message createAttachmentMail(final MailInfo info, File[] files) throws Exception {
        //创建邮件
