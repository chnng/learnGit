...
class TestA {
    ...
    TestA() {
        ...
        Request request = new Request.Builder().url("http://xianyu-video.alicdn" + ".com/1527082135228.813232")
                .addHeader("User-Agent", "Lavf/57.25.100")
                .addHeader("Accept", "*/*")
                .addHeader("Connection", "close")
                .addHeader("Host", "xianyu-video" + ".alicdn.com")
