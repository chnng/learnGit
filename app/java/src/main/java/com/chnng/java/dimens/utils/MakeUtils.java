package com.chnng.java.dimens.utils;


import com.chnng.java.dimens.constants.DimenTypes;
...
public class MakeUtils {
    ...
    private static final String XML_DIMEN_TEMPLETE = "<dimen name=\"dp%d\">%.1fdp</dimen>\r\n";
